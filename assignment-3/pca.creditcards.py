...
visualizer.show(outpath="charts/creditcards.k-means.PCA.KElbowVisualizer.png")
visualizer.poof()
...
# Finalize and render the figure
visualizer.show(
    outpath="charts/creditcards.k-means.PCA.InterclusterDistance.png")
visualizer.poof()
...
# Finalize and render the figure
visualizer.show(
    outpath="charts/creditcards.k-means.PCA.SilhouetteVisualizer.png")
...
plt.savefig('charts/expectation-max.PCA.creditcards.png')
