...
plt.title('Credit Cards Neural Network Hyperparameter "beta_1"')
plt.ylabel('Accuracy')
plt.xlabel('beta_1')
plt.savefig('charts/creditcards.neuralnetwork.ICA.beta_1.png')
...
line2, = plt.plot(params, test_results, 'r', label="Test")
plt.legend(handler_map={line1: HandlerLine2D(numpoints=2)})
plt.title('Credit Cards Neural Network Hyperparameter "beta_2"')
plt.ylabel('Accuracy')
plt.xlabel('beta_2')
plt.savefig('charts/creditcards.neuralnetwork.ICA.beta_2.png')
# https://medium.com/@mohtedibf/indepth-parameter-tuning-for-decision-tree-6753118a03c3
"""
clf = MLPClassifier(
    random_state=0,
...
plt.savefig('charts/creditcards.neuralnetwork.expectation-max.learningcurve.png')
...
plt.savefig('charts/creditcards.neuralnetwork.expectation-max.accuracy.png')
