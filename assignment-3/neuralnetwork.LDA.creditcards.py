...
X_train = clf.fit_transform(minmax_scale(X_train, feature_range=(0, 1)))

X_test = clf.fit_transform(minmax_scale(X_test, feature_range=(0, 1)))
...
plt.savefig('charts/creditcards.neuralnetwork.LDA.learningcurve.png')
...
plt.savefig('charts/creditcards.neuralnetwork.LDA.accuracy.png')
