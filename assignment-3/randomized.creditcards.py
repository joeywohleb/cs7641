...
visualizer.show(
    outpath="charts/creditcards.k-means.Randomized.KElbowVisualizer.png")
visualizer.poof()
...
# Finalize and render the figure
visualizer.show(
    outpath="charts/creditcards.k-means.Randomized.InterclusterDistance.png")
visualizer.poof()
...
plt.savefig('charts/expectation-max.randomized.creditcards.png')
