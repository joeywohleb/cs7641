...
visualizer.show(outpath="charts/creditcards.k-means.ICA.KElbowVisualizer.png")
visualizer.poof()
...
# Finalize and render the figure
visualizer.show(
    outpath="charts/creditcards.k-means.ICA.InterclusterDistance.png")
visualizer.poof()
...
# Finalize and render the figure
visualizer.show(
    outpath="charts/creditcards.k-means.ICA.SilhouetteVisualizer.png")
...
plt.savefig('charts/expectation-max.ICA.creditcards.png')
