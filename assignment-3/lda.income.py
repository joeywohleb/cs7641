...
visualizer.show(outpath="charts/income.k-means.LDA.KElbowVisualizer.png")
visualizer.poof()
...
# Finalize and render the figure
visualizer.show(
    outpath="charts/income.k-means.LDA.InterclusterDistance.png")
visualizer.poof()
...
# Finalize and render the figure
visualizer.show(
    outpath="charts/income.k-means.LDA.SilhouetteVisualizer.png")
...
plt.savefig('charts/expectation-max.lda.income.png')
