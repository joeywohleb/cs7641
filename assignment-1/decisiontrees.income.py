...
#     'max_depth': [1, 2, 3, 5, 13, 21, 34, 55, 89, 144],
#     'min_samples_split': [2, 3, 5, 13, 21, 34, 55, 89, 144],
#     'min_samples_leaf': [1, 2, 3, 5, 13, 21, 34, 55, 89, 144],
#     'max_leaf_nodes': [1, 2, 3, 5, 13, 21, 34, 55, 89, 144],
# }
...
plt.title('Income Decision Trees Hyperparameter "max_leaf_nodes"')
plt.ylabel('Accuracy')
plt.xlabel('max_leaf_nodes')
plt.savefig('income.decisiontrees.max_leaf_nodes.png')
...
line2, = plt.plot(params, test_results, 'r', label="Test")
plt.legend(handler_map={line1: HandlerLine2D(numpoints=2)})
plt.title('Income Decision Trees Hyperparameter "max_depth"')
plt.ylabel('Accuracy')
plt.xlabel('max_depth')
plt.savefig('income.decisiontrees.max_depth.png')
# https://medium.com/@mohtedibf/indepth-parameter-tuning-for-decision-tree-6753118a03c3
...
plt = plot_learning_curve(
    clf, 'Income Decision Trees Learning Curve', X_train, y_train, None, 10)
plt.savefig('income.decisiontrees.learningcurve.png')
