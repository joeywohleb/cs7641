...
#    ['euclidean', 'manhattan', 'chebyshev', 'seuclidean', 'mahalanobis']
...
plt.title('Credit Cards k-NN Hyperparameter "n_neighbors"')
plt.ylabel('Accuracy')
plt.xlabel('n_neighbors')
plt.savefig('creditcards.knn.n_neighbors.png')
...
line2, = plt.plot(params, test_results, 'r', label="Test")
plt.legend(handler_map={line1: HandlerLine2D(numpoints=2)})
plt.title('Credit Cards k-NN Hyperparameter "metric"')
plt.ylabel('Accuracy')
plt.xlabel('metric')
plt.savefig('creditcards.knn.metric.png')
# https://medium.com/@mohtedibf/indepth-parameter-tuning-for-decision-tree-6753118a03c3
...
plt = plot_learning_curve(
    clf, 'Credit Cards k-NN Learning Curve', X_train, y_train, None, 10)
plt.savefig('creditcards.knn.learningcurve.png')
