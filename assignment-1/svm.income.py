...
plt.title('Income SVM Hyperparameter "gamma"')
plt.ylabel('Accuracy')
plt.xlabel('gamma')
plt.savefig('income.svm.gamma.png')
...
line2, = plt.plot(params, test_results, 'r', label="Test")
plt.legend(handler_map={line1: HandlerLine2D(numpoints=2)})
plt.title('Income SVM Hyperparameter "tol"')
plt.ylabel('Accuracy')
plt.xlabel('tol')
plt.savefig('income.svm.tol.png')
# https://medium.com/@mohtedibf/indepth-parameter-tuning-for-decision-tree-6753118a03c3
...
plt = plot_learning_curve(
    clf, 'Income SVM Learning Curve', X_train, y_train, None, 10)
plt.savefig('income.svm.learningcurve.png')
