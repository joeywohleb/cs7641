...
plt.title('Income Boosting Hyperparameter "n_estimators"')
plt.ylabel('Accuracy')
plt.xlabel('n_estimators')
plt.savefig('income.boosting.n_estimators.png')
...
line2, = plt.plot(params, test_results, 'r', label="Test")
plt.legend(handler_map={line1: HandlerLine2D(numpoints=2)})
plt.title('Income Boosting Hyperparameter "max_depth"')
plt.ylabel('Accuracy')
plt.xlabel('max_depth')
plt.savefig('income.boosting.max_depth.png')
# https://medium.com/@mohtedibf/indepth-parameter-tuning-for-decision-tree-6753118a03c3
...
plt = plot_learning_curve(
    clf, 'Income Boosting Learning Curve', X_train, y_train, None, 10)
plt.savefig('income.boosting.learningcurve.png')
