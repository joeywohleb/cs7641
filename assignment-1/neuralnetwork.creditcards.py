...
plt.ylabel('Accuracy')
plt.xlabel('beta_1')
plt.savefig('creditcards.neuralnetwork.beta_1.png')
...
plt.ylabel('Accuracy')
plt.xlabel('beta_2')
plt.savefig('creditcards.neuralnetwork.beta_2.png')
# https://medium.com/@mohtedibf/indepth-parameter-tuning-for-decision-tree-6753118a03c3
...
plt.savefig('creditcards.neuralnetwork.learningcurve.png')
...
plt.savefig('creditcards.neuralnetwork.accuracy.png')
